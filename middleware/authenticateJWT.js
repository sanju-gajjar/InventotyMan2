...
const checkAuthenticated = (req, res, next) => {
    try {
        ...
        const isJsonRequest = contentType.includes('application/json') || req.xhr || req.path.includes('/api/');
        ...
        jwt.verify(token, secretKey, (err, user) => {
            if (err) {
                ...
                return res.render('login.ejs', { messages: { error: "Session expired, Please Login to continue" } });
            }
