...
async function generateInvoicePDF(transactionId, invoiceData, includeQR = true, sendEmail = false) {
    ...
    <head>
        ...
        <style>
            ...
            th{text-align:center;background-color:#e7e7e7}
            h1{margin:0;padding:0}
            .header h1{text-decoration:underline}
            .header{float:left}
            .logo{width:100px}
            .address{font-size:14px;margin-top:4px}
            .invoice-details{text-align:right;float:right;margin-bottom:5px}
            .invoice-details table{border:none}
            .invoice-details th{text-align:left}
            h2,h3{text-align:center}
            .invoice-summary-footer{display:inline-block;width:100%}
            .invoice-summary{float:right;text-align:right}
            .invoice-summary table td{border:none;text-align:right}
            .footer{float:left;text-align:left;display:flex;align-items:flex-end;gap:12px}
            .footer-text{max-width:520px}
            .payment-details{margin-left:20px}
            .main_wrapper{width:900px;margin:0 auto}
            tfoot tr td:first-child{background-color:#fff}
            tfoot tr td{background-color:#e7e7e7}
            .info-table{width:100%;margin-bottom:5px}
            .info-table th{text-align:left;background-color:transparent;font-weight:normal}
            .info-table td{padding:4px 8px}
            .customer-info{width:100%;margin-bottom:5px;border:1px solid}
            .customer-info th,.customer-info td{padding:4px}
            .customer-info th{text-align:left;width:100px;background-color:transparent;border:none;font-weight:normal}
            .customer-info td{width:41%;border:none}
            .qr-section{text-align:center;margin:0}
            .qr-section img{max-width:60px}
            .qr-section p{margin:2px 0 0;font-size:9px;color:#666}
            .sign-stamp-section{display:flex;justify-content:space-between;align-items:flex-end;margin-top:20px;padding-top:15px;border-top:1px solid #999}
            .sign-stamp-section img{max-height:100px;width:auto}
            .sign-label{text-align:center;font-size:11px;font-weight:bold;margin-top:3px}
        </style>
    </head>
    <body>
        <div class="main_wrapper">
            <div class="header">
                <h1><strong>THE CYCLE HUB</strong></h1>
                <span><strong>THE PHONER MOBILE ACCESSORIES HUB</strong></span>
                <div class="address">
                    <strong>Address:</strong>Shop No:G-101,B.T.Mall,Navjivan Mall Compound,Kalol-382721<br>
                    DIST-GANDHINAGAR,<strong>Contact No:</strong>7600004841
                </div>
            </div>
            <div class="invoice-details">
                <table>
                    <tr><th>Invoice No:</th><td>{{number}}</td></tr>
                    <tr><th><strong>Invoice Date:</strong></th><td>{{date}}</td></tr>
                    <tr><th><strong>State code:</strong></th><td>24</td></tr>
                    <tr><th><strong>GSTN No:</strong></th><td>24BNYPG4010L1ZU</td></tr>
                </table>
            </div>
            ...
            <table class="customer-info">
                <tr>
                    ...
                    <th>Mobile No:</th><td>{{customerPhone}}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <th>ID Proof:</th><td>ID Proof No:</td>
                </tr>
            </table>
            ...
            <div class="invoice-summary-footer">
                <div class="invoice-summary">
                    ...
                    <div class="sign-stamp-section">
                        <div>
                            <img src="/sign-stamp2.png" alt="Signature">
                            <div class="sign-label">Authorized Signature</div>
                        </div>
                        <div style="text-align:right">
                            <img src="/sign-stamp1.png" alt="Stamp">
                            <div class="sign-label">Official Stamp</div>
                        </div>
                    </div>
                </div>
                <div class="footer">
                    <div class="footer-text">
                        <p>In Words: <span>{{wordsMatter}} Paisa Only</span></p>
                        <p>Payment Mode:<strong>Cash</strong>/<strong>Online</strong>:{{totalAmount}}</p>
                        <p>Bill By:Keyur Gajjar</p>
                        <p style="margin-top:10px;margin-bottom:15px;font-size:11px;line-height:1.3">
                            Goods once sold will not be taken back. Warranty will be converted
                        </p>
                    </div>
                    ${includeQR ? '<div class="qr-section"><img src="{{qrCode}}" alt="Download Invoice"><p><strong>Scan to Download Invoice</strong></p></div>' : ''}
                </div>
            </div>
        </div>
    </body>
